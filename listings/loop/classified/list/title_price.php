<?php
$show_title_two_params_as_labels = apply_filters( 'stm_me_get_nuxy_mod', false, 'show_generated_title_as_label' );
...
$heading_font = ( apply_filters( 'stm_is_dealer_two', false ) ) ? 'normal-font' : 'heading-font';
...
<div class="meta-top list-card-top">

	<?php if ( apply_filters( 'stm_is_dealer_two', false ) && $is_sell_online && empty( $car_price_form_label ) ) : ?>
		<?php
		if ( ! empty( $sale_price ) ) {
			$price = $sale_price;
		}
